...
export const ButtonRotatingBackgroundGradient = ({children, route, isButton, onClick}: ButtonRotatingBackgroundGradientProps) => {
  if (isButton) {
    return (
      <button onClick={onClick} className="relative inline-flex h-12 overflow-hidden rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 transform hover:-translate-y-1 transition duration-400" >
