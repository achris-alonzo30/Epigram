    ...
    return (
        <div className="container grid grid-cols-1 gap-8 px-6 py-12 mx-auto lg:grid-cols-2">
          {MarketingCTALinks.map((link) => (
            <div className="flex flex-col items-center max-w-lg mx-auto text-center" key={link.title}>
